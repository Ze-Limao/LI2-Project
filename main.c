...
void mult(STACK* s) {
    ...
    if (X.t == INT && Y.t == INT) {
        ...
        P.t = DBL;
        P.data.f = Y.data.i * Y.data.f;
        push(s,P);
    }
    else if ((X.t == INT && Y.t == DBL)) {
        P.t = DBL;
        P.data.f = Y.data.f * Y.data.i;
        push(s,P);
    }
}
...
void freeSubArr(STACK *s, STACK *s2) {
    int t;
    STACK_ELEM X;
    STACK_ELEM Y;
    X.t = Arr;
...
void freeSubSTR(STACK *s, STACK *s2) {
    int t;
    STACK_ELEM X;
    STACK_ELEM Y;
    X.t = STR;
...
/*
                                ...
                                ▐░░░░░░░░░░░░░▌     ▐░░░░░░░░░░░░░▌  ▐░░░░░░░░░░░░▌
                                 ▀▀▀▀▀▀▀▀▀▀▀▀▀       ▀▀▀▀▀▀▀▀▀▀▀▀▀    ▀▀▀▀▀▀▀▀▀▀▀▀
 ヽ( ͝ ° ͜ʖ͡° )ﾉ ヽ( ͝ ° ͜ʖ͡° )ﾉヽ( ͝ ° ͜ʖ͡° )ﾉヽ( ͝ ° ͜ʖ͡° )ﾉヽ( ͝ ° ͜ʖ͡° )ﾉヽ( ͝ ° ͜ʖ͡° )ﾉ ヽ( ͝ ° ͜ʖ͡° )ﾉ     */